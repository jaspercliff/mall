...
<div>
  <n-icon size="20">
    <svg width="31" height="31" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M10 24H4C4 35.0457 12.9543 44 24 44C35.0457 44 44 35.0457 44 24H38" stroke="#333" stroke-width="2"
            stroke-linecap="round" stroke-linejoin="round"/>
      <path d="M24 44V14" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
